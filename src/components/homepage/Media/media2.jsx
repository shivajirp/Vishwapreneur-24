...
const Media2 = () => {
  ...
  return (
    <div className='relative bg-black'>
      ...
      <div className=' py-10 flex-col md:flex-row lg:flex w-screen h-fit text-white  place-content-around '>
                    
        {socialIcons.map((icon) => (
          <motion.div key={icon.platform} className=" flex-col  border-t-2 border-r-2 border-white rounded-lg p-3 text-center h-fit place-content-center hover:transform hover:translate-y-[-5px] hover:border-[1px] hover:transition-transform hover:ease-in-out hover:duration-700 duration-700  hover:border-solid hover:border-white hover:shadow-white hover:shadow-xl" >
            <i
