...
const Contact = () => {
  return (
    <div id="Contact">
      <div className="p-4 bg-black h-screen flex flex-col justify-center">
        <p className="main-heading mt-12 bg-gradient-to-r from-[#b74b9b] to-white text-transparent bg-clip-text text-3xl font-bold text-center py-8">
          Contact Us
        </p>
